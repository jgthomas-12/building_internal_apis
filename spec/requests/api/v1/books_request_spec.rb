...
describe "Books API" do
  ...
  it "can create a new book" do
    book_params = ({
                    ...
                    summary: "Jitterbug Perfume is a hilariously bizarre adventure that entwines
                    the realms of myth, magic, and beets as characters chase the essence of immortality through time.",
                    number_sold: 52342
                  })
  ...
  # Extra check to test for deletion
  # it "can destroy a book" do
  #   book = create(:book)
